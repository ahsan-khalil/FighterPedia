...
class ImageCollectionSelectorVC: UIViewController {
    ...
    weak var imgDelegate:ImageCollectionSelectorDelegator? = nil
...
extension ImageCollectionSelectorVC:UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
