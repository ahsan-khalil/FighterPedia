...
class SinglePicCollectionView: UICollectionView, UICollectionViewDelegateFlowLayout {
    ...
    override func getSelectedCell(_ collectionView: UICollectionView,
       ...
       if let cell = collectionView.dequeueReusableCell(
            ...
            let resizedImage = Utility.resizeImage(image: imageDataList[indexPath.row].uiImage, newWidth: 60)
            cell.setImage(image: resizedImage)
            cell.layer.borderWidth = 1
            cell.layer.borderColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
            cell.layer.cornerRadius = 3
            return cell
       } else {
            print("SinglePicCollectionView Cell is not generated")
       }
