...
class WallpaperRepository{
    static func getWallapaperList() -> [ImageDataContainer]{
        ...
        for i in 1...25{
            wallapaperList.append(ImageDataContainer(img: "\(tempStr)\(i)", uiImage: UIImage(named: "\(tempStr)\(i)")!))
        }
    ...
    static func getOperatorsList() -> [ImageDataContainer] {
        ...
        imgList.append(ImageDataContainer(img: "independent state of croatia",uiImage: UIImage(named: "independent state of croatia")!))
