...
class UISingleCeTableView: UITableView {
    ...
    override func getSelectedCell(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = tableView.dequeueReusableCell(
                                    withIdentifier: SingleCellTableViewCell.identifier) as? SingleCellTableViewCell {
            ...
            print("UISingleCeTableView cell is nil")
            return UITableViewCell()
        }
    }
    override func slideLeft(_ tableView: UITableView,
